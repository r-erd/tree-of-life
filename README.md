...
- **YAML Driven:** Passion definitions are managed in a simple `src/data/passions.yaml` file, organized cleanly into structural subcategories.
...
Edit `src/data/passions.yaml` to add, modify, or remove passions.
